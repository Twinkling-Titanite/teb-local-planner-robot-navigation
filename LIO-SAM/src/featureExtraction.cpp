...
public:
    ...
    pcl::PointCloud<PointType>::Ptr passFilterCloud;

    pcl::VoxelGrid<PointType> downSizeFilter;
    pcl::PassThrough<PointType> passFilter;
    ...
    void initializationValue()
    {
        ...
        passFilterCloud.reset(new pcl::PointCloud<PointType>());
    ...
    void extractFeatures()
    {
        ...
        for (int i = 0; i < N_SCAN; i++)
        {
            ...
            passFilter.setInputCloud(surfaceCloudScan);
            passFilter.setFilterFieldName("z");
            passFilter.setFilterLimits(-1, 5.0);
            passFilter.filter(*surfaceCloudScan);
